...
export function priceWithMonthlyDiscount(hourlyRate, billableDays, discount) {
  ...
  const fullMonths = Math.floor(billableDays / billableDaysPerMonth);
  const remainingDays = billableDays % billableDaysPerMonth;

  const monthlyRate = dailyRate * billableDaysPerMonth;
